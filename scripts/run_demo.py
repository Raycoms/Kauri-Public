...
if __name__ == "__main__":
    ...
    ssh.connect("172.16.52.15",port,user,password,timeout = 10)
    ...
    for j in range(1, 20):
        ...
        ssh.exec_command("cd test/libhotstuff && ./examples/hotstuff-client --idx {} --iter -750 --max-async 1000 > clientlog{} 2>&1 &".format(1, j))
