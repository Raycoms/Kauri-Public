...
if __name__ == "__main__":
    ...
    ssh.connect("172.16.52.22",port,user,password,timeout = 10)
    ...
    for j in range(1, 10):
        ...
        ssh.exec_command("cd test/libhotstuff && ./examples/hotstuff-client --idx $((j%10)) --iter -1 --max-async 4 > clientlog{} 2>&1 &".format(j))
