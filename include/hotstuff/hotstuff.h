...
class HotStuffBase: public HotStuffCore {
    ...
    std::vector<ReplicaID> faulty = { 0, 11, 22, 33, 44, 55, 66, 77, 88, 1 }; // ,12, 23, 34, 45, 56, 67, 78, 89, 2 //7, 8, 9, 10, 18, 19, 20, 21, 29, 30, 31, 32, 40, 41, 42, 43, 51, 52, 53, 54, 62, 63, 64, 65, 74, 75, 76, 85, 86, 87, 96, 97, 98};
    /* statistics */
    uint64_t fetched;
    uint64_t delivered;
    uint64_t failures;
